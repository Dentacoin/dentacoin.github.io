...
<h3 class="xyz_lnap_inner_head">Follow Us </h3>
...
<h3 class="xyz_lnap_inner_head">Support</h3>
...
<p><a target="_blank" href="https://wordpress.org/support/plugin/linkedin-auto-publish/reviews/" >Please Rate Us
 </a></p>


<a target="_blank" href="https://wordpress.org/support/plugin/linkedin-auto-publish/reviews/" ><span class="xyz_new_star"></span></a>

<p style="width:100%;"><a target="_blank" href="https://wordpress.org/support/plugin/linkedin-auto-publish/" >Create a ticket at Wordpress forum</a></p>
</div>
<div class="xyz_lnap_new_subscribe">
<h3 class="xyz_lnap_inner_head">Stay tuned for our updates</h3>
...
<input class="xyz_lnap_name"  type="text" placeholder="Name" name="field1" value="<?php
...
<input id="xyz_lnap_submit_lnap" class="sbmt_btn" type="submit" value="Subscribe" name="Submit"  onclick="javascript: if(!verify_fields()) return false; " />
