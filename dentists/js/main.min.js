...
SetMegamenuPosition()}
var st=$(this).scrollTop();if(st>lastScroll){$('.sticky').removeClass('header-appear');$('.dropdown.on').removeClass('on').removeClass('open').find('.dropdown-menu').fadeOut(100)}else $('.sticky').addClass('header-appear');lastScroll=st;if(lastScroll<=headerHeight)
...
function equalizeHeight(){$(document).imagesLoaded(function(){if($(window).width()<768){$('.equalize').equalize({equalize:'outerHeight',reset:!0});$('.equalize.md-equalize-auto').children().css("height","");$('.equalize.sm-equalize-auto').children().css("height","");$('.equalize.xs-equalize-auto').children().css("height","");return!1}else if($(window).width()<992){$('.equalize').equalize({equalize:'outerHeight',reset:!0});$('.equalize.md-equalize-auto').children().css("height","");$('.equalize.sm-equalize-auto').children().css("height","");return!1}else if($(window).width()<1199){$('.equalize').equalize({equalize:'outerHeight',reset:!0});$('.equalize.md-equalize-auto').children().css("height","");return!1}else{$('.equalize').equalize({equalize:'outerHeight',reset:!0})}})}
...
$(window).resize(function(event){$("nav.navbar.bootsnav ul.nav").each(function(){$("li.dropdown",this).on("mouseenter",function(e){if($(window).width()>991){$(this).find('.equalize').equalize({equalize:'outerHeight',reset:!0});return!1}})});setTimeout(function(){SetResizeContent()},500);event.preventDefault()});$(document).ready(function(){"use strict";$("nav.navbar.bootsnav ul.nav").each(function(){$("li.dropdown",this).on("mouseenter",function(){if($(window).width()>991){$(this).find('.equalize').equalize({equalize:'outerHeight',reset:!0});return!1}})});$('a[data-toggle="tab"]').on('shown.bs.tab',function(e){var target=$(e.target).attr("href");if($(window).width()>991){$(target).find('.equalize').equalize({equalize:'outerHeight',reset:!0});return!1}});var pgurl=window.location.href.substr(window.location.href.lastIndexOf("/")+1);var $hash=window.location.hash.substring(1);if($hash){$hash="#"+$hash;pgurl=pgurl.replace($hash,"")}else{pgurl=pgurl.replace("#","")}
...
$('.scroll-top-arrow').fadeIn('slow');else $('.scroll-top-arrow').fadeOut('slow')});$(document).on('click','.scroll-top-arrow',function(){$('html, body').animate({scrollTop:0},800);return!1});var swiperFull=new Swiper('.swiper-full-screen',{pagination:'.swiper-pagination',paginationClickable:!0,loop:!0,autoplay:5000,slidesPerView:1,keyboardControl:!0,preventClicks:!1,nextButton:'.swiper-button-next',prevButton:'.swiper-button-prev'});var swiperAutoFade=new Swiper('.swiper-auto-fade',{pagination:'.swiper-pagination',loop:!0,autoplay:5000,slidesPerView:1,paginationClickable:!0,keyboardControl:!0,preventClicks:!1,effect:'fade',nextButton:'.swiper-button-next',prevButton:'.swiper-button-prev'});var swiperSecond=new Swiper('.swiper-slider-second',{pagination:'.swiper-pagination-second',slidesPerView:1,paginationClickable:!0,keyboardControl:!0,preventClicks:!1,nextButton:'.swiper-button-next',prevButton:'.swiper-button-prev'});var swiperThird=new Swiper('.swiper-slider-third',{pagination:'.swiper-pagination-third',slidesPerView:1,paginationClickable:!0,keyboardControl:!0,preventClicks:!1,nextButton:'.swiper-button-next',prevButton:'.swiper-button-prev'});var swiperNumber=new Swiper('.swiper-number-pagination',{pagination:'.swiper-number',paginationClickable:!0,autoplay:4000,preventClicks:!1,autoplayDisableOnInteraction:!1,paginationBulletRender:function(swiper,index,className){return'<span class="'+className+'">'+pad((index+1))+'</span>'}});var swiperVerticalPagination=new Swiper('.swiper-vertical-pagination',{pagination:'.swiper-pagination-white',direction:'vertical',slidesPerView:1,paginationClickable:!0,spaceBetween:0,preventClicks:!1,mousewheelControl:!0});var swiperClients=new Swiper('.swiper-slider-clients',{pagination:null,slidesPerView:4,paginationClickable:!0,autoplay:3000,preventClicks:!1,autoplayDisableOnInteraction:!1,breakpoints:{480:{slidesPerView:1},650:{slidesPerView:2},850:{slidesPerView:3}}});var swiperThreeSlides=new Swiper('.swiper-three-slides',{pagination:'.swiper-pagination-three-slides',paginationClickable:!0,slidesPerView:3,keyboardControl:!0,mousewheelControl:!1,preventClicks:!1,nextButton:'.second-swiper-button-next',prevButton:'.second-swiper-button-prev',breakpoints:{480:{slidesPerView:1},767:{slidesPerView:2},850:{slidesPerView:2}}});var swiperFourSlides=new Swiper('.swiper-four-slides',{pagination:'.swiper-pagination-four-slides',autoplay:3000,slidesPerView:4,paginationClickable:!0,keyboardControl:!0,mousewheelControl:!1,preventClicks:!1,nextButton:'.swiper-button-next',prevButton:'.swiper-button-prev',breakpoints:{850:{slidesPerView:2},650:{slidesPerView:2},480:{slidesPerView:1}}});var swiperDemoHeaderStyle=new Swiper('.swiper-demo-header-style',{pagination:'.swiper-pagination-demo-header-style',loop:!0,autoplay:3000,slidesPerView:4,paginationClickable:!0,keyboardControl:!0,mousewheelControl:!1,preventClicks:!0,slidesPerGroup:4,nextButton:'.swiper-button-next',prevButton:'.swiper-button-prev',breakpoints:{1199:{slidesPerGroup:2,slidesPerView:2},767:{slidesPerGroup:1,slidesPerView:1}}});var swiperAutoSlideIndex=0;var swiperAutoSlide=new Swiper('.swiper-auto-width',{scrollbar:'.swiper-scrollbar',scrollbarHide:!1,scrollbarDraggable:!0,slidesPerView:'auto',centeredSlides:!0,spaceBetween:80,preventClicks:!1,scrollbarSnapOnRelease:!0,nextButton:'.swiper-next-style2',prevButton:'.swiper-prev-style2',mousewheelControl:!0,speed:1000,keyboardControl:!0,breakpoints:{1199:{spaceBetween:60},960:{spaceBetween:30},767:{spaceBetween:15}},onSlideChangeEnd:function(swiper){swiperAutoSlideIndex=swiper.activeIndex}});var swiperMultipurpose=new Swiper('.swiper-bottom-scrollbar-full',{scrollbar:'.swiper-scrollbar',scrollbarHide:!1,scrollbarDraggable:!0,slidesPerView:'auto',scrollbarSnapOnRelease:!0,grabCursor:!0,preventClicks:!1,nextButton:'.swiper-button-next',prevButton:'.swiper-button-prev',mousewheelControl:!0,spaceBetween:30,keyboardControl:!0,speed:1000,breakpoints:{767:{direction:'vertical',scrollbarHide:!0,spaceBetween:0,pagination:!1,autoHeight:!0}}});var swiperAutoHieght=new Swiper('.swiper-auto-height-container',{nextButton:'.swiper-button-next',prevButton:'.swiper-button-prev',effect:'fade',loop:!0,preventClicks:!1,autoHeight:!0});var swiperMultyRow=new Swiper('.swiper-multy-row-container',{nextButton:'.swiper-portfolio-next',prevButton:'.swiper-portfolio-prev',slidesPerView:4,spaceBetween:15,scrollbarSnapOnRelease:!0,autoplay:3000,autoplayDisableOnInteraction:!0,breakpoints:{991:{slidesPerView:2},767:{slidesPerView:1}}});var swiperBlog=new Swiper('.swiper-blog',{slidesPerView:"auto",centeredSlides:!0,spaceBetween:15,scrollbarSnapOnRelease:!0,autoplay:5000,autoplayDisableOnInteraction:!0,preventClicks:!1,loop:!0,loopedSlides:3});var swiperPresentation=new Swiper('.swiper-presentation',{slidesPerView:4,centeredSlides:!0,spaceBetween:30,scrollbarSnapOnRelease:!0,autoplay:3000,autoplayDisableOnInteraction:!0,preventClicks:!0,loop:!0,loopedSlides:6,nextButton:'.swiper-button-next',prevButton:'.swiper-button-prev',breakpoints:{991:{spaceBetween:15,slidesPerView:2},767:{slidesPerView:1}}});if(isIE()){setTimeout(function(){$(document).imagesLoaded(function(){if($(".swiper-full-screen").length>0)
swiperFull.onResize()
...
swiperPresentation.onResize()
if($(".swiper-demo-header-style").length>0)
swiperDemoHeaderStyle.onResize()},500);setTimeout(function(){var window_width=$(window).width();if(window_width<768){if($(".swiper-bottom-scrollbar-full").length>0){if(swiperMultipurpose){swiperMultipurpose.detachEvents();swiperMultipurpose.destroy(!0,!0);swiperMultipurpose=undefined}
swiperMultipurpose=new Swiper('.swiper-bottom-scrollbar-full',{scrollbar:'.swiper-scrollbar',scrollbarHide:!1,scrollbarDraggable:!0,slidesPerView:'auto',scrollbarSnapOnRelease:!0,grabCursor:!0,preventClicks:!1,nextButton:'.swiper-button-next',prevButton:'.swiper-button-prev',mousewheelControl:!0,spaceBetween:30,keyboardControl:!0,speed:1000,breakpoints:{767:{direction:'vertical',scrollbarHide:!0,spaceBetween:0,pagination:!1,autoHeight:!0}}})}}else{if($(".swiper-bottom-scrollbar-full").length>0){if(swiperMultipurpose){swiperMultipurpose.detachEvents();swiperMultipurpose.destroy(!0,!0);swiperMultipurpose=undefined}
swiperMultipurpose=new Swiper('.swiper-bottom-scrollbar-full',{scrollbar:'.swiper-scrollbar',scrollbarHide:!1,scrollbarDraggable:!0,slidesPerView:'auto',scrollbarSnapOnRelease:!0,grabCursor:!0,preventClicks:!1,nextButton:'.swiper-button-next',prevButton:'.swiper-button-prev',mousewheelControl:!0,spaceBetween:30,keyboardControl:!0,speed:1000})}}},500);if($(".swiper-auto-width").length>0&&swiperAutoSlide){swiperAutoSlide.detachEvents();swiperAutoSlide.destroy(!0);swiperAutoSlide=undefined;$(".swiper-auto-width .swiper-wrapper").css("transform","").css("transition-duration","");$(".swiper-auto-width .swiper-slide").css("margin-right","");setTimeout(function(){swiperAutoSlide=new Swiper('.swiper-auto-width',{scrollbar:'.swiper-scrollbar',scrollbarHide:!1,scrollbarDraggable:!0,slidesPerView:'auto',centeredSlides:!0,spaceBetween:80,preventClicks:!1,scrollbarSnapOnRelease:!0,nextButton:'.swiper-next-style2',prevButton:'.swiper-prev-style2',mousewheelControl:!0,speed:1000,keyboardControl:!0,breakpoints:{1199:{spaceBetween:60},960:{spaceBetween:30},767:{spaceBetween:15}},onSlideChangeEnd:function(swiper){swiperAutoSlideIndex=swiper.activeIndex}});swiperAutoSlide.slideTo(swiperAutoSlideIndex,1000,!1)},1000)}});var scrollAnimationTime=1200,scrollAnimation='easeInOutExpo';$(document).on('click.smoothscroll','a.scrollto',function(event){event.preventDefault();var target=this.hash;if($(target).length!=0){$('html, body').stop().animate({'scrollTop':$(target).offset().top},scrollAnimationTime,scrollAnimation,function(){window.location.hash=target})}});if($('.full-width-pull-menu').length>0){$(document).on('click','.full-width-pull-menu .inner-link',function(e){$(".full-width-pull-menu .close-button-menu").trigger("click");var _this=$(this);setTimeout(function(){var target=_this.attr("href");if($(target).length>0){$('html, body').stop().animate({'scrollTop':$(target).offset().top})}},500)})}
...
$(this).removeClass('active');else $(this).addClass('active')});$('button.navbar-toggle').on("click",function(e){if(isMobile){$(".cart-content").css('opacity','0');$(".cart-content").css('visibility','hidden')}});$('a.dropdown-toggle').on("click",function(e){if(isMobile){$(".cart-content").css('opacity','0');$(".cart-content").css('visibility','hidden')}});$(document).on('click','.navbar-collapse [data-toggle="dropdown"]',function(event){var $innerLinkLI=$(this).parents('ul.navbar-nav').find('li.dropdown a.inner-link').parent('li.dropdown');if(!$(this).hasClass('inner-link')&&$innerLinkLI.hasClass('open')){$innerLinkLI.removeClass('open')}
