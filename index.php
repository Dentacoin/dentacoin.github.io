            ...
            <div class="container">
                ...
                <div class="row push-top-md">
                    ...
                    <div class="col-md-4 text-center feature scrollme animateme"
                        ...
                        data-translatex="200"
                        >
                        <img width="100" src="web/img/what/megaphone.png" alt="reviews">
                        <h3 class="h4">Voting Rights</h3>
                        <strong>Get your place in the DCN Advisory Board.</strong>
                        <p>
                          The integrated voting system gives each coin owner the opportunity to vote on all important decisions regarding the Dentacoin Foundation.
                        </p>
                    </div>
                    <!-- /store of value -->
