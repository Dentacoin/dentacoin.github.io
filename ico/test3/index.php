          ...
          <div class="shell">
            <div class="range range-sm-center">
              <div class="cell-sm-12">
                <h3 class="text-lowercase"><img src="dcn.png" alt="Dentacoin"><br> <span class="text-capitalize">The</span>Blockchain Solution for the Global Dental Industry.</h3>
                <div class="range offset-top-30">
                  <div class="cell-xs-12">
                    <div class="countdown-wrap block-centered">
                      <h4 class="offset-top-30">Dentacoin Token Sale starts October 1st, 14:00 (UTC)</h4>
                      <div data-type="until" data-date="2017-10-01T14:00:00.000Z" data-format="wdhms" data-color="#126585" data-bg="rgba(255,255,255,0.2)" data-width="0.02" class="DateCountdown DateCountdown-1"></div>
                    </div>
                  </div>
                </div>
