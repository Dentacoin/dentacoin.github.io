    ...
    //var addressBook = "0xa8a7F95037140745B31c5b99AD9811cC0793cfC3";
...
*/
    ...
    //var ABook = web3.eth.contract(abookABI);


    // setup token instance
    var token = Token.at(DCNaddress);
    //var abook = ABook.at(addressBook);
...
/* show address
$("#_showAddress").click(function(){
    var uname = $("#_getUName").val();
    var byteName = string2Bin(uname);


      abook.addressOf(byteName, function(error, _address){
        $("#addressResponse").show();
        return $("#addressResponse_body").html(String(_address));
      });
  });
- show address */
