    ...
    <div class="page">
                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-nav-inner">
                    <ul class="rd-navbar-nav">
                      <li><a href="https://www.dentacoin.com/ru">Home</a>
                      </li>
                      <li><a href="..\white-paper\Whitepaper-en.pdf" target="_blank">Whitepaper</a>
                      </li>
                      <li><a href="#who">Team</a>
                      </li>
                      <li><a href="https://dentacoin.com/ru/ico-faq/">FAQ</a>
                      </li>
                      ...
                      <li><a class="fa fa-globe" href="#" style="font-size: 16px;"></a>
                        <ul class="rd-navbar-dropdown">
                          <li><a href="https://www.dentacoin.com/">English</a>
                          </li>
          ...
          <div class="shell">
            <div class="range range-sm-center">
              <div class="cell-sm-12">
                <h3 class="text-lowercase"><img src="dcn.png" alt="Dentacoin"><br> <span class="text-capitalize">Решение</span> блочной цепи (блокчейн) для мировой стоматологической индустрии.</h3>
                <div class="range offset-top-30">
                  <div class="cell-xs-12">
                    <div class="countdown-wrap block-centered">
                      <h4 class="offset-top-30">Начало продажи токенов Дентакоин:</h4>
              ...
              <p style="font-size: 16px;" class="offset-top-15"><span class="text-blue text-ubold h6"><?php echo get_member_count()?></span> subscribers waiting for the start…</p>
                <form action="//dentacoin.us15.list-manage.com/subscribe/post?u=2db886e44db15e869246f6964&amp;id=6906b05278" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate form-modern form-inverse offset-top-10" target="_blank" novalidate>
                  <div id="mc_embed_signup_scroll" class="form-group">
                    ...
                    <div class="clear"><input type="submit" value="Регистр" name="subscribe" id="sign" class="btn btn-primary btn-block offset-top-35"></div>
                  </div>
      ...
      <section id="what" class="text-center section-100">
        ...
        <div class="range range-sm-center">
          <div class="cell-sm-12">
            <div class="col-sm-4">
              <div class="panel panel-custom panel-light cell-sm-10 cell-md-8 cell-lg-6">
                <div id="accordionOneHeading2" role="tab" class="panel-heading">
                  <div class="panel-title"><a role="button" href="..\white-paper\Whitepaper-en.pdf" class="collapsed" target="_blank"><center>Белый лист</center>
                    <div class="panel-arrow"></div></a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-sm-4">
                <div class="panel panel-custom panel-light cell-sm-10 cell-md-8 cell-lg-6">
                    <div id="accordionOneHeading2" role="tab" class="panel-heading">
                      <div class="panel-title"><a role="button" href="concept-summary/index.html" class="collapsed">Краткое описание концепции
                        <div class="panel-arrow"></div></a>
                      </div>
                    </div>
                </div>
            ...
            <div class="col-sm-4">
                <div class="panel panel-custom panel-light cell-sm-10 cell-md-8 cell-lg-6">
                    <div id="accordionOneHeading2" role="tab" class="panel-heading">
                      <div class="panel-title"><a href="https://dentacoin.com/ru/ico-faq/" role="button" class="collapsed">FAQ<div class="panel-arrow"></div></a>
                      </div>
                    </div>
                </div>
            </div>
          ...
          <div class="shell">
            <p class="cell-sm-8 cell-md-8 cell-lg-6 offset-top-30">Дентакоин — это первая концепция блокчейн, разработанная для мировой стоматологической индустрии. Все физические лица по всему миру могут пользоваться токенами Дентакоин ERC20. Проект Дентакоин создан с целью усовершенствовать стоматологические услуги во всем мире и сделать их более доступными за счет массовости. Планируется разработка и внедрение множества инструментов на основе блокчейн.
            </p>
          </div>
        </div>
        <div class="range range-condensed range-xs-center range-sm-left">
          <div class="cell-xs-10 cell-sm-4 height-fill">
            <article class="icon-box icon-box-top-line">
              ...
              <div class="box-body">
                <p class="text-gray-base"><strong>Станьте движущей силой перемен.</strong><br>Первая платформа на основе блокчейн для надежного обзора стоматологического лечения позволяет пациентам оставлять отзывы и влиять на мировую стоматологическую индустрию.</p>
          ...
          <div class="cell-xs-10 cell-sm-4 height-fill offset-top-40 offset-sm-top-0">
            <article class="icon-box icon-box-top-line">
              ...
              <div class="box-body">
                <p class="text-gray-base"><strong>Застрахуйте здоровье ваших зубов.</strong><br>Революционная концепция стоматологического страхования на основе блокчейн, при которой существует общая ответственность за здоровье человека, а интересы дантистов и пациентов совпадают.</p>
          ...
          <div class="cell-xs-10 cell-sm-4 height-fill offset-top-40 offset-sm-top-0">
            <article class="icon-box icon-box-top-line">
              ...
              <div class="box-body">
                <p class="text-gray-base"><strong>Лечите весь организм.</strong><br>Децентрализованная база всех медицинских записей пациентов, данные которой максимально защищены, обновляются и предоставляются только пациентам или дантистам по соответствующему запросу.</p>
              </div><a href="#" class="btn btn-icon-only btn-icon-single btn-icon-default"><span class="icon icon-sm material-icons-arrow_forward"></span></a>
            </article>
          </div>
          <div class="cell-xs-10 cell-sm-4 height-fill offset-top-40 offset-sm-top-0">
            <article class="icon-box">
              ...
              <div class="box-body">
                <p class="text-gray-base"><strong>Формируйте устойчивые привычки по уходу за зубами.</strong><br>Интерактивное приложение для пациентов с пошаговой инструкцией ухода за зубами после лечения, направленной на развитие длительных привычек по гигиене полости рта у детей и взрослых.</p>
              </div><a href="#" class="btn btn-icon-only btn-icon-single btn-icon-default"><span class="icon icon-sm material-icons-arrow_forward"></span></a>
            </article>
          </div>
          <div class="cell-xs-10 cell-sm-4 height-fill offset-top-40 offset-sm-top-0">
            <article class="icon-box">
              ...
              <div class="box-body">
                <p class="text-gray-base"><strong>Оставьте ваш отзыв.</strong><br>Приложение WebApp служит для получения отзывов потребителей и собирает самые свежие данные для рыночных исследований с помощью анкет и вознаграждений. Стоматолог может получить доступ к данной ценной информации и применять эту «мудрость» для совершенствования.</p>
              </div><a href="#" class="btn btn-icon-only btn-icon-single btn-icon-default"><span class="icon icon-sm material-icons-arrow_forward"></span></a>
            </article>
          </div>
          <div class="cell-xs-10 cell-sm-4 height-fill offset-top-40 offset-sm-top-0">
            <article class="icon-box">
              ...
              <div class="box-body">
                <p class="text-gray-base"><strong>Торговля дентакоинами (DCN) по всему миру.</strong><br>Децентрализованная торговая платформа для торговли стоматологической продукцией, материалами и оборудованием, которая напрямую связывает производителей, стоматологов и пациентов. Вам больше не понадобится строить длинные цепи поставок и оплачивать дорогие международные транзакции.</p>
              </div><a href="#" class="btn btn-icon-only btn-icon-single btn-icon-default"><span class="icon icon-sm material-icons-arrow_forward"></span></a>
            </article>
          </div>
        </div>
          ...
          <div class="shell bg-cape-cod context-dark section-100 section-md-90">
            ...
            <div class="range offset-top-60 list-md-dashed">
              <div class="cell-sm-4 offset-top-40 offset-sm-top-0">
                <div id="circulatingDCN" class="h1 small counter-bold counter"></div>
                <div class="offset-top-0 text-bold text-dark text-uppercase">Circulating Supply</div>
              </div>
              <div class="cell-sm-4 offset-top-40 offset-sm-top-0">
                <div id="lockedDCN" class="h1 small counter-bold counter"></div>
                <div class="offset-top-0 text-bold text-dark text-uppercase">Locked Amount</div>
              </div>
              <div class="cell-sm-4 offset-top-40 offset-sm-top-0">
                <div id="totalDCN" class="h1 small counter-bold counter"></div>
      ...
      <section id="how" class="section-100">
        <div class="shell">
          <div class="range range-sm-center">
            <div class="cell-sm-12">
              <h3 class="text-center">КАК</h3>
              <div class="block-centered cell-sm-10 cell-md-8 cell-lg-6 offset-top-60">
                <p class="col-xs-8 col-xs-push-2 text-big-19">На данный момент существуют два способа получения дентакоинов. Зарабатывайте и покупайте.</p>
                <ol type="1" class="col-xs-8 col-xs-push-2">
                  <li>
                    <p class="text-big">Как заработать:</p>
                    <p>Зарегистрируйтесь на нашем первом инструменте <a href="https://reviews.dentacoin.com/" terget="_blank">Trusted Review Platform</a></p>
                    <p>Являясь пациентом партнерской клиники, участвуйте в программах лояльности пациентов</p>
                    <p>Участвуйте в нашей программе поощрения Bounty Program за первичное размещение монет (ICO) <a href="https://bitcointalk.org/index.php?topic=2033283" target="_blank">объявленной на этом сайте</a></p>
                  </li>
                  <li>
                    <p class="text-big">Покупайте:</p>
                    <p>Дентакоины уже включены в список сайта <a href="https://coinmarketcap.com/assets/dentacoin">Coinmarketcap</a> и свободно продаются на следующих международных биржевых платформах: <a href="https://www.cryptopia.co.nz/Exchange/?market=DCN_BTC"  target="_blank">Cryptopia</a>, <a href="https://etherdelta.github.io/#DCN-ETH"  target="_blank">EtherDelta</a>, <a href="https://mercatox.com/exchange/DCN/BTC" target="_blank">Mercatox</a> and <a href="https://www.coinexchange.io/" target="_blank">Coinexchange</a></p>
                    <p>Вы можете также купить дентакоины на нашем первичном размещении монет (ICO), которое начинается в 14:00 по Гринвичу (GMT) 01 октября 2017 г.</p>
                  </li>
                </ol>
              </div>
            </div>
      ...
      <section id="who" class="section-100">
        ...
        <div class="shell">
          ...
          <div class="offset-top-22 offset-md-top-40">
            <div data-items="1" data-sm-items="3" data-stage-padding="15" data-loop="true" data-autoplay="true" data-margin="15" data-mouse-drag="true" data-nav="true" data-dots="false" class="owl-carousel owl-carousel-center owl-nav-modern owl-style-minimal owl-style-minimal-inverse text-center">
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Профессор, доктор Димитар Димитракиев</h4>
                  <div class="text-dusty-gray profile-width">Учредитель Фонда Дентакоин <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Учредитель. Высокоуважаемый лектор университета. Имеет более 27 лет опыта работы на финансовых рынках. Посвятил жизнь науке и технике. Член Общества вычислительного интеллекта при Институте инженеров электротехники и электроники (IEEE), EADM и Союза автоматизации и информатики.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
              ...
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Филипп Гренцебах</h4>
                  <div class="text-dusty-gray profile-width">Соучредитель/Бизнес-разработчик/Магистр искусств <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Гений в области экономики в Дентакоин. Получил образование в области права, экономики и управления бизнесом. Внедрил концепцию тройного критерия для Дентакоин в процессе интеграции технической устойчивости. Выступает за бесплатные децентрализованные рынки.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                  <div class="link-group">
              ...
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Иеремия Гренцебах</h4>
                  <div class="text-dusty-gray profile-width">Соучредитель/Главный разработчик <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Наш волшебник по системам кодирования. Один из самых первых специалистов в области технологии блокчейн. Уже 8 лет погружен в технологию одноранговой связи. Внес вклад в разработку таких криптовалют как Ethereum, Waves, ZCash, uPort, Статус, imToken, Byteball. Большой сторонник децентрализации и прозрачности.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                  <div class="link-group">
              ...
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Сергей Ушаков</h4>
                  <div class="text-dusty-gray profile-width">Разработчик пользовательского интерфейса и программист на языке Solidity <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Наш ускоритель трансформации. Настоящий энтузиаст технологии блокчейн. Имеет ученую степень по робототехнике и мехатронике; специализируется на разработке ПО. Опыт разработки пользовательского интерфейса, программирования на языке Solidity, перехода на цифровые технологии и автоматизации бизнес-процессов.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                  <div class="link-group">
              ...
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Айредин Стоянов</h4>
                  <div class="text-dusty-gray profile-width">Графический дизайнер <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Наш гений визуализации. Получил образование в области мультимедийного дизайна, программных систем и технологий. Имеет опыт применения визуальных средств для передачи идей, которые вдохновляют, информируют и заинтересовывают. Увлекается созданием видео и фото продукции.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                  <div class="link-group">
              ...
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Доктор Елена Тума</h4>
                  <div class="text-dusty-gray profile-width">Менеджер проекта: Платформа надежного обзора <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Голос пациента. Сертифицирована Международным учебным центром по стоматологической имплантологии (IFZI). Глубоко убеждена в способности пациентов улучшать индустрию с помощью обратной связи. В настоящее время разрабатывает инфраструктуру блокчейн для сбора и хранения надежных отзывов в качестве основы для реализации стратегии, ориентированной на пациента. Управляет рисками, бюджетом, ресурсами, связью с третьими лицами в отношении проекта Trusted Review Platform.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
              ...
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Доктор Десислава Герчева</h4>
                  <div class="text-dusty-gray profile-width">Менеджер проекта: Стоматологическое страхование <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Наш компас справедливости. Опытный стоматолог и преподаватель стоматологии. Профессиональная миссия: создать первоклассную стоматологию, доступную для всех. Борется с неравным доступом к стоматологической помощи путем постоянного поиска новых технологий, инновационных методов лечения и вариантов справедливой оплаты. Очень интересуется моделями страхования по технологии одноранговой связи. Управляет рисками, бюджетом, сроками, ресурсами, связью с третьими лицами в отношении проекта Dental Insurance.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                </div>
              </div>
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Доктор Виолина Филипова</h4>
                  <div class="text-dusty-gray profile-width">Менеджер проекта: Платформа маркетинговых исследований <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Мыслитель здравоохранения. Активный исследователь и лектор по теме: «Стоматологические проблемы и их влияние на здоровье». Осознает важность актуальных подробных данных о рыночных исследованиях. Работает над созданием методов на основе блокчейн для сбора таких данных, их анализа, обеспечения доступа к ним и их пригодности как инструмента по улучшению качества всего лечения, связи и делопроизводства в индустрии. Управляет рисками, бюджетом, сроками, ресурсами, связью с третьими лицами в отношении проекта Market Research Platform.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                </div>
              </div>
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Доктор Деян Новаковский</h4>
                  <div class="text-dusty-gray profile-width">Менеджер проекта: Healthcare Database <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Наш движок данных о пациентах. Опытный стоматолог, увлеченный имплантологией. Видит в исключительных возможностях диагностики обязательную предпосылку для точного и безрискового лечения. В настоящее время изучает, как использовать преимущества блокчейн для разработки хранилища для точной, актуальной и подробной информации о пациентах. Управляет рисками, бюджетом, сроками, ресурсами, связью с третьими лицами в отношении проекта Healthcare Database.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                </div>
              </div>
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Доктор Димо Даскалов</h4>
                  <div class="text-dusty-gray profile-width">Специалист по развитию стоматологической индустрии <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Самое сильное связующее звено между дентакоинами (DCN) и стоматологической индустрией. Ведущий дантист, руководящий группой из 19 стоматологов. Инструктор по протезированию зубов. Постоянно совершенствует стоматологические услуги, внедряя передовые технологии, демонстрирует блестящий опыт работы с пациентами и одновременно снижает затраты. Стремится стать частью сдвига парадигмы.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
              ...
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Доктор Иван Пеев</h4>
                  <div class="text-dusty-gray profile-width">Специалист по Dentistry 4.0 <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Наш проводник в мир цифровой имплантологии. Специалист по стоматологическим имплантатам с огромным опытом оказания высокотехнологичных стоматологических услуг с помощью хирургических шаблонов и компьютеризированных систем имплантации. Инструктор по применению обучающих симуляторов (фантомов), сертифицированный Международным учебным центром по стоматологической имплантологии (IFZI). Имеет шестое чувство в области самых современных технических решений.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                </div>
              </div>
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Цветомир Иванов</h4>
                  <div class="text-dusty-gray profile-width">Инженер Industry 4.0 <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Мыслитель будущего. Специалист по цифровой стоматологии, CAD/CAM и 3D-печати. Занимается поиском способов достижения максимальной эффективности, снижения расходов и увеличения доходов посредством перехода к цифровым технологиям и автоматизации. Осуществляет непрерывное исследование, оценку и внедрение высокотехнологичных стоматологических инноваций.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                </div>
              </div>
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Доника Краева</h4>
                  <div class="text-dusty-gray profile-width">Менеджер по стратегическим связям <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Посол связей. Переводит большие и сложные идеи на язык целевой группы. Имеет опыт в области медицинского интернет-маркетинга. Разрабатывала системы обратной связи и программы лояльности пациентов для международных стоматологических клиник. Занимается поиском способов применения блокчейн для построения стоматологической индустрии, управляемой пациентами.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                  <div class="link-group">
              ...
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Мариам Нишанян</h4>
                  <div class="text-dusty-gray profile-width">Связи с общественностью <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Наш публичный голос. Международный опыт в области PR, управления социальными медиа, консалтинга в области коммуникации и проектирования пользовательского интерфейса. Интересуется инвестированием в криптовалюты. Квалифицированный предприниматель с опытом развития стартапов. В постоянном поиске новых задач.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                  <div class="link-group">
              ...
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Бетина Богданова</h4>
                  <div class="text-dusty-gray profile-width">Старший юрисконсульт <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Голос закона. Обеспечивает юридическую поддержку управления проектами компании Дентакоин. Консультировала финансово-технологические и стоматологические компании. Имеет солидное юридическое образование, полученное в таких учебных заведениях, как Австралийский национальный университет, Гронингенский университет и Школа права Гарвардского университета. Сотрудничала с ВОЗ и Гарвардской школой общественного здравоохранения.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                </div>
              </div>
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Веселин Матов</h4>
                  <div class="text-dusty-gray profile-width">Менеджер по управлению отношениями с клиентами и организации поставок <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Наш профи по отношениям с клиентами. Занимается определением технологических тенденций и их внедрением в качестве конкурентных преимуществ. Имеет опыт в области управления отношениями с клиентами, внедрении стоматологического ПО и управления закупками. Получил образование в сфере компьютерных систем и технологий. Постоянное изучает современные инновации в интересах пациентов.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                </div>
              </div>
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Али Хашем</h4>
                  <div class="text-dusty-gray profile-width">Специалист по продажам и поддержке клиентов <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Связной. Многолетний опыт работы представителем по отношениям с клиентами и менеджером по продажам в сфере услуг. Всегда находит способы, как сделать так, чтобы цели компании совпадали с потребностями клиентов. Изучает потенциал блокчейн для построения более прочных связей с клиентами.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
              ...
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Христо Градечлиев</h4>
                  <div class="text-dusty-gray profile-width">Финансовый директор <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Мастер финансов. Отвечает за управление финансовыми и бухгалтерскими отделами. Магистр бизнес-администрирования (МВА) в области права. Имеет опыт в сфере платежных экосистем, построения аналитических инструментов, процессов и команд для управления доходами, расходами и рисками, свойственными платежному пространству. Обладает большим чутьем к успешным инвестициям.</small>
                    <div class="divider-fullwidth bg-porcelain"></div>
                  </div>
                </div>
              </div>
              <div class="owl-item text-center">
                <div class="thumbnail-variant-5">
                  ...
                  <h4>Юлия Радева</h4>
                  <div class="text-dusty-gray profile-width">Менеджер по развитию бизнеса <br>
                    <div class="divider-fullwidth bg-porcelain"></div>
                      <small>Наш бизнес-пионер. 11-летний опыт управления развитием бизнеса. Движущая сила нескольких успешных концепций стоматологической клиники. Ведет наблюдение за применением стоматологических инноваций и постоянно изучает возможности роста в области стоматологии.</small>
      ...
      <section class="section-100">
        <div slass="shell">
          <div class="range range-sm-center">
            <div class="text-center text-italic cell-md-6 cell-xs-16 cell-lg-16 text-big-21 quote" style="margin: 0 30px 0 30px;">​"Похоже, блокчейн готовит стоматологии самую большую встряску. Такие новаторские проекты как Дентакоин могут навсегда изменить современную индустрию стоматологии."
          ...
          <h4 class="text-center">Другие публикации о Дентакоин:</h4>
            ...
            <div class="row">
              <div class="col-sm-12">
                <ul class="social nav">
                  ...
                  <li class=" ">
                    <a href="https://t.me/dentacoin" target="_blank" class="sl">
                  ...
                  <li class=" ">
                    <a href="https://www.youtube.com/c/DentacoinFoundation" target="_blank" class="sl">
