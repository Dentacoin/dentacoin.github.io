...
<html lang="en" class="wide wow-animation">
  ...
  <body>
                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-nav-inner">
                    <ul class="rd-navbar-nav">
                        <li><a href="https://www.dentacoin.com/de">Home</a>
                        </li>
                        <li><a href="..\white-paper\Whitepaper-en.pdf" target="_blank">Whitepaper</a>
                        </li>
                        <li><a href="https://www.dentacoin.com/de/#who">Team</a>
                        </li>
                        <li><a href="https://dentacoin.com/de/ico-faq/">FAQ</a>
                        </li>
                        <li><a href="https://www.dentacoin.com/de/ico/">ICO</a>
                        </li>
                        <li><a href="https://www.dentacoin.com/de/wallet/">Wallet</a>
                        </li>
                        <li><a href="https://www.dentacoin.com/blog/" target="_blank">Blog</a>
                        </li>
                        <li><a class="fa fa-globe" href="#" style="font-size: 16px;"></a>
                            <ul class="rd-navbar-dropdown">
                                <li><a href="https://www.dentacoin.com/wallet">English</a>
                                </li>
                                <li><a href="blog-grid.html">中文</a>
                                </li>
                                <li><a href="blog-line.html">Dutch</a>
                                </li>
                                <li><a href="blog-masonry.html">Русский</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
    ...
    <section id="what" class="text-center section-75">
        <div class="shell">
            <h3 class=".offset-top-30 text-blue">DENTACOIN <span class="text-capitalize">Token Verkauf<span></h3>
            <div class="range offset-top-15">
            <div class="cell-xs-12">
                <div class="countdown-wrap block-centered">
                    <h4>14:00 Uhr GMT, 1. November 2017</h4>
            ...
            <div class="range range-sm-center offset-top-120">
                <div class="lead about-text cell-sm-6 cell-md-5 cell-lg-4 offset-top-0 offset-sm-top-0 offset-xl-top-0" id="mc_embed_signup">
                    <p style="font-size: 16px;" class="offset-top-15"><span class="text-blue text-ubold h6"><?php echo get_member_count(); ?></span> Abonnenten warten auf den Start…</p>
    ...
    <section class="text-center section-30">
        <div class="shell">
            ...
            <div class="range range-sm-left">
                <p style="font-size: 24px;" class="cell-sm-12 text-left text-blue">Mein Dentacoin Balance</p>
    ...
    <section class="text-center section-30">
        <div class="shell">
            <h3 class="text-blue"><small class="text-capitalize">Übertragung</small></h3>
            <div class="range range-sm-left">
                <p style="font-size: 24px;" class="cell-sm-12 text-left text-blue">Übertragung Dentacoins</p>
                <p class="text-bold cell-sm-12 text-left text-blue offset-top-15">DCN Adresse des Empfängers</p>
                <div class="cell-sm-12">
                    <div id="checkBalanceResponse" class="form-group">
                ...
                <p class="text-bold cell-sm-12 text-left text-blue offset-top-15">Menge</p>
                <div class="cell-sm-12">
                    ...
                    <div class="range" style="margin: 0;">
                        <div class="lead about-text cell-sm-4 cell-md-3 cell-lg-3 offset-top-0 offset-sm-top-0 offset-xl-top-0">
                            <button id="_transfer" class="btn btn-primary btn-block offset-top-35">Übertragung</button>
                        </div>
                        <div id="transferTokenResponse" class="alert alert-success">
                            <h4>Übertragung Dentacoins</h4>
            ...
            <div class="range range-sm-left">
                <div class="col-md-10 col-md-offset-1 clearfix">
                    ...
                    <p class="lead about-text text-center">
                        Handel Dentacoins am Austausch wie
                    ...
                    <p class="lead about-text text-center">
                        oder überprüfen Sie Ihre bestehenden Dentacoin <a class="text-blue" href="https://michaelsnoeren.nl/dcn/" target="_blank">Investition</a>
                    </p>
                    <p class="lead about-text text-center">
                        Sie vertrauen dieser Währung nicht? Du hast recht! Überprüfen Sie es auf <a class="text-blue" href="https://etherscan.io/token/0x08d32b0da63e2C3bcF8019c9c5d849d7a9d791e6" target="_blank">Etherscan</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="range range-sm-center">
                <div class="lead about-text cell-sm-4 cell-md-3 cell-lg-2 offset-top-0 offset-sm-top-0 offset-xl-top-0" id="mc_embed_signup">
                    <form class="validate form-modern form-inverse offset-top-30" novalidate="">
                        <div class="clear"><a href="https://dentacoin.com/conferences/" target="_blank" class="btn btn-primary btn-block offset-top-35">Triff das Team</a></div>
                    </form>
                </div>
        </div>
    </section>
